...
class InventoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'items.*.code' => ['required', 'string', 'unique:inventories,code', 'max:50'],
            "items.*.item_image" => "nullable|file|max:5120|mimes:jpg,jpeg,png,avif",
            ...
            "method" => "string|in:POST|required",
            "limit" => "nullable|numeric|in:10,25,50,100",
        ];
    }
}
